use utf8;
package FPx::Schema::Result::FpPocket;
...
=head1 TABLE: C<fp_pockets>

=cut

__PACKAGE__->table("fp_pockets");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:mmceQ4pRIGyziH/4a8Ofiw
